...
if( empty($hrefattr))
  $hrefattr = $params->get( 'hrefattr', '' ); //maximum number of items to display
	...
	for($i=0; $i<$max_items; $i++) {
        ...
        if( $display_style == "vertical" ) {
			...
			<tr align="center" class="<?php echo $sectioncolor ?>">
				<td><?php $ps_product->show_snapshot($prodlist[$rand_prods[$i]], $show_price, $show_addtocart, true, $hrefattr); ?>--<br />
				</td>
			</tr><?php
        }
